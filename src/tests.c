...
void ecmult_const_random_mult(void) {
    ...
    secp256k1_gej b;
    secp256k1_ecmult_const(&b, &a, &xn, 256, 256);
...
void ecmult_const_commutativity(void) {
    ...
    secp256k1_ecmult_const(&res1, &secp256k1_ge_const_g, &a, 256, 256);
    secp256k1_ecmult_const(&res2, &secp256k1_ge_const_g, &b, 256, 256);
    secp256k1_ge_set_gej(&mid1, &res1);
    secp256k1_ge_set_gej(&mid2, &res2);
    secp256k1_ecmult_const(&res1, &mid1, &b, 256, 256);
    secp256k1_ecmult_const(&res2, &mid2, &a, 256, 256);
    secp256k1_ge_set_gej(&mid1, &res1);
    secp256k1_ge_set_gej(&mid2, &res2);
...
void ecmult_const_mult_zero_one(void) {
    ...
    secp256k1_ecmult_const(&res1, &point, &zero, 3, 3);
    secp256k1_ge_set_gej(&res2, &res1);
    CHECK(secp256k1_ge_is_infinity(&res2));
    secp256k1_ecmult_const(&res1, &point, &one, 2, 2);
    secp256k1_ge_set_gej(&res2, &res1);
    ge_equals_ge(&res2, &point);
    secp256k1_ecmult_const(&res1, &point, &negone, 256, 256);
...
void ecmult_const_chain_multiply(void) {
    ...
    for (i = 0; i < 100; ++i) {
        ...
        secp256k1_ecmult_const(&point, &tmp, &scalar, 256, 256);
    }
...
void test_constant_wnaf(const secp256k1_scalar *number, int w) {
    ...
    bits = 128;
#endif
    skew = secp256k1_wnaf_const(wnaf, &&num, w, bits, bits);
